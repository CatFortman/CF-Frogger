...
namespace GEX
{
		...
		_statsText()
	{
		...
		TextureHolder::getInstance().load(TextureID::Frog, "Media/Textures/FroggerAtlas.jpg");
		TextureHolder::getInstance().load(TextureID::FrogJump, "Media/Textures/FroggerAtlas.jpg");
		TextureHolder::getInstance().load(TextureID::FrogLives, "Media/Textures/FroggerAtlas.jpg");
